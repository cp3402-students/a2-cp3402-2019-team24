<?php
/**
 * Teamtwentyfour Theme Customizer.
 *
 ...
 */
function Teamtwentyfour_customize_register( $wp_customize ) {
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			...
			'theme_bg_color', 
				array(
					'label'		=> __( 'Header and footer background color', 'Teamtwentyfour'),
					'section'	=> 'colors',
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			...
			'interactive_color', array(
				'label'		=> __( 'Interactive color (links etc)', 'Teamtwentyfour' ),
				'section'	=> 'colors',
	...
	$wp_customize->add_section( 'theme_options', 
		array(
			'title'			=> __( 'Theme Options', 'Teamtwentyfour' ),
			'priority'		=> 95,
			'capability'	=> 'edit_theme_options',
			'description'	=> __( 'Change how much of a post is displayed on index and archive pages.', 'Teamtwentyfour' )
		)
	);
	...
	$wp_customize->add_setting(	'length_setting',
		array(
			'default'			=> 'excerpt',
			'type'				=> 'theme_mod',
			'sanitize_callback' => 'Teamtwentyfour_sanitize_length', // Sanitization function appears further down
			'transport'			=> 'postMessage'
		)
	);

	// Add the controls
	$wp_customize->add_control(	'Teamtwentyfour_length_control',
		array(
			'type'		=> 'radio',
			'label'		=> __( 'Index/archive displays', 'Teamtwentyfour' ),
			'section'	=> 'theme_options',
			'choices'	=> array(
				'excerpt'		=> __( 'Excerpt (default)', 'Teamtwentyfour' ),
				'full-content'	=> __( 'Full content', 'Teamtwentyfour' )
			),
...
add_action( 'customize_register', 'Teamtwentyfour_customize_register' );

/**
 * Binds JS handlers to make Theme Customizer preview reload changes asynchronously.
 */
function Teamtwentyfour_customize_preview_js() {
	wp_enqueue_script( 'Teamtwentyfour_customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), '20151215', true );
}
add_action( 'customize_preview_init', 'Teamtwentyfour_customize_preview_js' );
...
function Teamtwentyfour_sanitize_length( $value ) {
...
if ( ! function_exists( 'Teamtwentyfour_header_style' ) ) :
/**
 * Styles the header image and text displayed on the blog.
 *
 * @see Teamtwentyfour_custom_header_setup().
 */
function Teamtwentyfour_header_style() {
